...
##Plot Stacked histogram body signals - distance (Supplementary Figure 3)
###Sort data
xdata=read.table("Supp_Fig3_data.csv", header=T, sep=";", fill=T, dec=",", stringsAsFactors=T) #dataset sorted in Excel 
