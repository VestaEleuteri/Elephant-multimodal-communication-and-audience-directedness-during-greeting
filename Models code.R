...
xdata=read.table("Greet_data.csv", header=T, sep=";", fill=T, dec=".", stringsAsFactors=T)
...
xdata=read.table("GLMMs_data.csv", header=T, sep=";", fill=T, dec=",", stringsAsFactors=T)
str(xdata)
...
xdata=read.table("GLMMs_data.csv", header=T, sep=";", 
