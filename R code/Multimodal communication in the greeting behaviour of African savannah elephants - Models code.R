...
#GLMM1: Do individual and social factors affect the order of combinations of vocalisations with gestures or body acts by elephants during greeting?----
...
#GLMM2: Do individual and social factors affect the use of combinations of Rumble and Ear-Flapping by elephants during greeting?----
...
#Supplementary Information Model: Do tail body acts rely on the state of visual attention of the recipient?----
##Sort data
